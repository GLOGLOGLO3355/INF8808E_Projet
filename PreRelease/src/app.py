...
app.layout = html.Div(
    children=[
        ...
        html.Div(
            [
                html.H2(
                    "Understanding Academic Performance: A Data-Driven Exploration"
                ),
                html.P(
        ...
        dcc.Graph(id="example-sunburst", figure=grouped_bar.get_grouped_bar_chart()),
        html.Div(
            [
        ...
        html.Div(
            [
                html.H2(
                    "Visualizing Motivation Through Social and Environmental Factors"
                ),
                html.P(
        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        dcc.Graph(
                            figure=extracurricular_boxplot.get_extracurricular_boxplot()
                        )
                    ],
                    style={"display": "flex", "justifyContent": "center"},
                ),
                ...
                html.Div(
                    [
                        ...
                        html.Div(
                            [
                                dcc.Graph(
                                    figure=sleep_heatmap.get_sleep_motivation_heatmap()
                                )
                            ],
                            style={"display": "flex", "justifyContent": "center"},
                        ),
                ...
                html.Div(
                    [
                        html.H2(
                            "Conclusion: Unveiling the Complexity of Academic Success"
                        ),
                        html.P(
...
@app.callback(Output("scatter-plot", "figure"), [Input("tutoring-filter", "value")])
